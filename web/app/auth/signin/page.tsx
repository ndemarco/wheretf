        ...
        <div className="mt-8 bg-white dark:bg-gray-800 p-8 rounded-lg shadow space-y-6">
          <div className="flex justify-center space-x-4 mb-6">
            <button
              ...
              className={`pb-2 border-b-2 ${!isRegistering ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500'}`}
            >
              Sign In
            </button>
            <button
          ...
          {isRegistering ? (
            <form action={registerAction} className="space-y-4">
              ...
              <button type="submit" disabled={isRegisterPending} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50">
            ...
            <form action={loginAction} className="space-y-4">
              ...
              <button type="submit" disabled={isLoginPending} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50">
